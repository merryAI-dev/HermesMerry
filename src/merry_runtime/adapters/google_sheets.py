...
OPERATOR_CONSOLE_LABELS: dict[str, dict[str, str]] = {
    "Candidate Detail": {
        ...
        "region": "지역",
        "industry": "산업",
        "p1_region_match": "P1 소재지 해당",
        "p1_region_rule": "P1 소재지 기준",
        "p1_region_detail": "P1 소재지 근거",
        "p1_purpose_match": "P1 주목적 해당",
        "p1_purpose_detail": "P1 주목적 근거",
        "summary": "요약",
        ...
        "kvic_matched_investors": "KVIC 매칭 투자사",
        "kvic_active_fund_count": "KVIC 활성 펀드 수",
        "kvic_active_amount_eok": "KVIC 활성 운용액(억원)",
        "kvic_fund_fields": "KVIC 출자 분야",
        "kvic_representative_funds": "KVIC 대표 펀드",
        "kvic_profile_tags": "KVIC 프로필 태그",
        "kvic_next_expiry_at": "KVIC 다음 만기일",
    },
    "SMINFO Enrichment": {
        "collected_at": "수집시각",
